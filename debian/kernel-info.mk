...
KERNEL_BOOTIMAGE_CMDLINE = earlycon=msm_serial_dm,0xc170000 androidboot.hardware=qcom msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 sched_enable_hmp=1 sched_enable_power_aware=1 service_locator.enable=1 swiotlb=1 firmware_class.path=/vendor/firmware_mnt/image loop.max_part=7 console=tty0 droidian.lvm.prefer systemd.unified_cgroup_hierarchy=0 v4l2loopback.devices=2 v4l2loopback.video_nr=0,1 v4l2loopback.card_label=Droidian_back,Droidian_front v4l2loopback.exclusive_caps=1,1 v4l2loopback.max_buffers=2
